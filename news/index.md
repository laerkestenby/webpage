...
<details>
  ...
  [Overall analysis template](https://docs.google.com/document/d/1eBScQbF6F-YbHrgSylydmEF3CZyILUHCPV5PIfxIXpg/)  
  **Questions:**  
  Is it surprising that individual-level predictions from all 19 models are often not in unanimous agreement?  
  Is there a clinical context, where individuals undergo several risk predictions for the same outcome using different prediction models?  
  How can the consistency of individual predictions within the same model be evaluated?  
